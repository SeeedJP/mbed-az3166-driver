...
/* LWIP 1.4.0 compatible */
//#define UN_COMPLETE_FUNCTION
...
typedef struct ip_addr_packed ip4_addr_p_t;
...
static bool lwip_connected = true;  // false;
...
static nsapi_error_t _mbed_lwip_gethostbyname(nsapi_stack_t *stack, const char *host, nsapi_addr_t *addr, nsapi_version_t version)
{
    ip_addr_t lwip_addr;
...
#endif
static nsapi_error_t _mbed_lwip_socket_open(nsapi_stack_t *stack, nsapi_socket_t *handle, nsapi_protocol_t proto)
{
...
static nsapi_error_t _mbed_lwip_socket_close(nsapi_stack_t *stack, nsapi_socket_t handle)
{
...
static nsapi_error_t _mbed_lwip_socket_bind(nsapi_stack_t *stack, nsapi_socket_t handle, nsapi_addr_t addr, uint16_t port)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
    ip_addr_t ip_addr;
...
static nsapi_error_t _mbed_lwip_socket_listen(nsapi_stack_t *stack, nsapi_socket_t handle, int backlog)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
...
static nsapi_error_t _mbed_lwip_socket_connect(nsapi_stack_t *stack, nsapi_socket_t handle, nsapi_addr_t addr, uint16_t port)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
    ip_addr_t ip_addr;
...
#else
    err_t err = netconn_connect(s->conn, &ip_addr, port, 5000);
#endif
...
static nsapi_size_or_error_t _mbed_lwip_socket_send(nsapi_stack_t *stack, nsapi_socket_t handle, const void *data, nsapi_size_t size)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
...
static nsapi_size_or_error_t _mbed_lwip_socket_recv(nsapi_stack_t *stack, nsapi_socket_t handle, void *data, nsapi_size_t size)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
...
static nsapi_size_or_error_t _mbed_lwip_socket_sendto(nsapi_stack_t *stack, nsapi_socket_t handle, nsapi_addr_t addr, uint16_t port, const void *data, nsapi_size_t size)
{
#ifdef UN_COMPLETE_FUNCTION
    struct lwip_socket *s = (struct lwip_socket *) handle;
    ip_addr_t ip_addr;
...
static nsapi_size_or_error_t _mbed_lwip_socket_recvfrom(nsapi_stack_t *stack, nsapi_socket_t handle, nsapi_addr_t *addr, uint16_t *port, void *data, nsapi_size_t size)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
    struct netbuf *buf;
...
static nsapi_error_t _mbed_lwip_setsockopt(nsapi_stack_t *stack, nsapi_socket_t handle, int level, int optname, const void *optval, unsigned optlen)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
...
static void _mbed_lwip_socket_attach(nsapi_stack_t *stack, nsapi_socket_t handle, void (*callback)(void *), void *data)
{
    struct lwip_socket *s = (struct lwip_socket *)handle;
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_gethostbyname(stack, host, addr, version);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_socket_open(stack, handle, proto);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_socket_close(stack, handle);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_socket_bind(stack, handle, addr, port);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_socket_listen(stack, handle, backlog);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_socket_connect(stack, handle, addr, port);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_size_or_error_t result = _mbed_lwip_socket_send(stack, handle, data, size);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_size_or_error_t result = _mbed_lwip_socket_recv(stack, handle, data, size);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_size_or_error_t result = _mbed_lwip_socket_sendto(stack, handle, addr, port, data, size);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_size_or_error_t result = _mbed_lwip_socket_recvfrom(stack, handle, addr, port, data, size);
    lwip_unlock();
...
{
    lwip_lock();
    nsapi_error_t result = _mbed_lwip_setsockopt(stack, handle, level, optname, optval, optlen);
    lwip_unlock();
...
{
    lwip_lock();
    _mbed_lwip_socket_attach(stack, handle, callback, data);
    lwip_unlock();
}
